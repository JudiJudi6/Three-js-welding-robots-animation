...
export function robot3(scene, x, y, z) {
  ...
  const basisBlock = box(scene, 40, 10, 30, "", 1, 1, 0xc18ddd);
  ...
  const phaseTwoBlock2 = box(scene, 5, 20, 10, "", 1, 1, 0xbbd11d);
